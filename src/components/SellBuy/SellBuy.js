...
import { SellBuyStyled, SellBuyTypeStyled, SellBuyNameStyled, SellBuyReturnStyled, SellBuyReturnAmountStyled } from "./SellBuy.styled";
  ...
  return (
    <SellBuyStyled type={type}>
      <Flex alignItems='center'>
        ...
        <Flex flex='0 0 auto'>
          <Button bg='#fff' color='#0264fb'>Sell</Button>
        </Flex>
        <Flex></Flex>
      </Flex>
    </SellBuyStyled>
