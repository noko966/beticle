...
import {CompetionContainerStyled, CompetionFooterStyled, CompetionNameStyled, CompetionContentStyled, CompetionTypeStyled, CompetitionTeamsContainerStyled, CompetitionOddsGroupStyled, CompetitionOddsGroupContainerStyled} from './Competition.styled';
...
const Competition = ({ name, type, scoreHT,scoreAT, HT, AT, oddsBuyName, oddsBuy, oddsSellName, oddsSell }) =>{
    return (
